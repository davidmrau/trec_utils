FOLDER=../results
../lib/galago/galago-3.10-bin/bin/galago threaded-batch-search --index=../collections/robust04_index_galago/ ../collections/robust04_test/04.testset_num_query_lower.json --scorer=bm25 --caseFold=false > ../results/robust_TREC_test_top_1000_bm25_caseFold
